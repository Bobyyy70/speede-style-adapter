-- HOTFIX 005: Ajout statuts manquants à l'ENUM statut_commande_enum
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'stock_reserve';
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'en_picking';
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'pret_expedition';
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'etiquette_generee';
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'expedie';
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'livre';
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'retour';
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'erreur';
ALTER TYPE statut_commande_enum ADD VALUE IF NOT EXISTS 'annule';
