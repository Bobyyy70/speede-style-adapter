-- Mettre à jour la fonction pour utiliser des positions en minuscules par défaut
CREATE OR REPLACE FUNCTION public.generer_emplacements_auto(
  ...
  p_capacite_kg NUMERIC DEFAULT 500.0,
  p_capacite_unites INTEGER DEFAULT 100
)
RETURNS INTEGER
LANGUAGE plpgsql
SECURITY DEFINER
