...
// Icons imports
import { LayoutDashboard, Settings, LogOut, Search, Menu, X, Bell, Package, TruckIcon, RotateCcw, Boxes, ClipboardList, RefreshCw, MapPin, Activity, Workflow, DollarSign, UserCog, Plug, Cloud, FileSpreadsheet, MessageSquare, Send, Box, Truck, Users, Eye, ChevronDown, Smartphone } from "lucide-react";
        ...
        <header className="sticky top-0 z-40 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
          <div className="flex h-16 items-center gap-4 px-6">
            ...
            <Popover open={searchOpen} onOpenChange={setSearchOpen}>
              ...
              <PopoverContent className="w-96 p-0" align="start">
                <Command>
                  ...
                  <CommandList>
                    {searchLoading ? <div className="py-6 text-center text-sm">Recherche...</div> : searchResults.length === 0 && searchQuery ? <CommandEmpty>Aucun résultat trouvé</CommandEmpty> : <CommandGroup>
            ...
            <div className="ml-auto flex items-center gap-4">
              {(userRole === 'admin' || userRole === 'gestionnaire') && <div className="flex items-center gap-2">
          ...
          {/* Breadcrumbs */}
          {breadcrumbs.length > 0 && <div className="px-6 py-3 border-t">
              <Breadcrumb>
                <BreadcrumbList>
