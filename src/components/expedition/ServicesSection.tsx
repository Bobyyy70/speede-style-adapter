...
export const ServicesSection = ({ commandeId }: ServicesSectionProps) => {
  // NOTE: Cette fonctionnalité est temporairement désactivée car la table ligne_service_commande
  // a été remplacée par le nouveau système de services personnalisés (demande_service_personnalise)
  // TODO: Implémenter l'affichage des services personnalisés liés à cette commande
  
  return (
    <div className="text-center py-8 text-muted-foreground">
      <Package className="h-12 w-12 mx-auto mb-2 opacity-50" />
      <p>Les services logistiques seront affichés prochainement</p>
      <p className="text-xs mt-2">Nouveau système de services personnalisés en cours d'implémentation</p>
    </div>
  );
  
  /* Ancien code désactivé - À remplacer par nouveau système
